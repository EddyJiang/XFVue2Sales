...
export default {
    ...
    methods: {
        submitForm() {
            this.$refs.login.validate((valid) => {
                if (valid) {
                    ...
                    axios
                        .post(`${this.$baseurl.identityUrl}/identity?usercode=` + usercode + '&password=' + password)
                        .then((res) => {
        ...
        saveActionTypr(usercode) {
            this.$api.mid_actiontype.getdata(this.$baseurl.applicationid).then((res) => {
        ...
        saveMouleToLs(usercode) {
            this.$api.mid_module.getdata(this.$baseurl.applicationid).then((res) => {
        ...
        saveRouters(usercode) {
            this.$api.mid_gform.getdata(this.$baseurl.applicationid).then((res) => {
                var datas = res.rows;
