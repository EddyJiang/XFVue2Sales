...
<template>
    <div class="dialog">
        ...
        <!-- dialog组件 -->
        <el-dialog ref="dialogs" title="税票类型列表" append-to-body :visible.sync="show" :close-on-click-modal="false" width="70%">
            <el-row :gutter="10">
                <el-col :span="9">
                    <el-form-item label="税票类型编号" prop="vattype">
                        <el-input v-model="searchform.vattype" placeholder="请输入税票类型编号" @input="fetchTableData"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="9">
                    <el-form-item label="税票类型名称" prop="vattypename">
                        <el-input v-model="searchform.vattypename" placeholder="请输入税票类型名称" @input="fetchTableData"></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
...
export default {
    ...
    methods: {
        ...
        showdiolog() {
            if (!this.disable) {
                this.searchform.vattype = '';
                this.searchform.vattypename = '';
                this.show = true;
                this.fetchTableData();
            }
        },
        ...
        // 回车事件
        inputEnterEvent() {
            this.searchform.vattype = this.str;
            this.$api.gvattype
                .getDataByPage(
                    this.commEntity.pagination.pageIndex,
                    this.commEntity.pagination.pageSize,
