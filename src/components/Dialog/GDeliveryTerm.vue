...
<template>
    <div class="dialog">
        ...
        <!-- dialog组件 -->
        <el-dialog ref="dialogs" title="提货方式列表" append-to-body :visible.sync="show" :close-on-click-modal="false" width="70%">
            <!-- 表格区域 -->
            <CommTable
                ref="table"
                :height="400"
...
export default {
    ...
    methods: {
        ...
        // 回车事件
        inputEnterEvent() {
            this.searchform.deliveryid = this.str;
            this.$api.gdeliveryterm
                .getDataByPage(
                    this.commEntity.pagination.pageIndex,
                    this.commEntity.pagination.pageSize,
