...
<template>
    <div class="dialog">
        ...
        <!-- dialog组件 -->
        <el-dialog ref="dialogs" title="铝锭来源列表" append-to-body :visible.sync="show" :close-on-click-modal="false" width="70%">
            <el-row :gutter="10">
                <el-col :span="9">
                    <el-form-item label="铝锭来源编号" prop="specno">
                        <el-input v-model="searchform.specno" placeholder="请输入铝锭来源编号" @input="fetchTableData"></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
...
export default {
    ...
    methods: {
        ...
        // 回车事件
        inputEnterEvent() {
            this.searchform.specno = this.str;
            this.$api.imatspec
                .getDataByPage(
                    this.commEntity.pagination.pageIndex,
                    this.commEntity.pagination.pageSize,
